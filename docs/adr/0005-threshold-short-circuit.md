...
When Stage 3 (Retrieval) returns no chunks above the 0.65 L2 distance threshold, Stage 4 (LLM Generation) is skipped entirely. A pre-written static Darja fallback response is returned immediately.
